...
augroup customSpell
    autocmd!
    autocmd FileType text,gitcommit,markdown setlocal spell spelllang=en_us spellfile=~/.vim/spell/en.utf-8.add
...
" Enabling html templates for .gohtml filetype
" .tmpl files enabled by default
